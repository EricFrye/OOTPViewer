...
public class FileLoader implements Runnable {
	 ...
	 */
	public FileLoader (File src, Scanner fd, Data data, Map <String, Integer> mappings, Quantifier queries) {
		this.fd = fd;
		this.data = data;
	...
	public void run () {
		...
		while (fd.hasNextLine()) {
			...
			if (this.queries.test(this.mappings, toAdd)) {
